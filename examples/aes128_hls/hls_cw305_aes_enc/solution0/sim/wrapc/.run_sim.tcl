...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AES128Encrypt.autotvin.dat"
	set constFileTvOut       "AES128Encrypt.autotvout.dat"
	set constFileHdlTvIn     "AES128Encrypt.autohdltvin.dat"
	set constFileHdlTvOut    "AES128Encrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
