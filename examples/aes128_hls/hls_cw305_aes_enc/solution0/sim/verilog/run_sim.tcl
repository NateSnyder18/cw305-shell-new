...
if {[file isfile AES128Encrypt.autotvin.dat]} {
	file delete -force AES128Encrypt.autotvin.dat
}

if {[file isfile AES128Encrypt.autotvout.dat]} {
	file delete -force AES128Encrypt.autotvout.dat
}
