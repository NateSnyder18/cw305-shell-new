...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AES128Encrypt.autotvin_data.dat"
         "c.AES128Encrypt.autotvin_key.dat"
         "c.AES128Encrypt.autotvin_plaintext.dat"
         "c.AES128Encrypt.autotvin_ciphertext.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AES128Encrypt.autotvout_data.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
