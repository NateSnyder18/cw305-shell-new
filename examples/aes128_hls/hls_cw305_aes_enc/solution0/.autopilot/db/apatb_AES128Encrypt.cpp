...
#define AUTOTB_TVOUT_key "../tv/cdatafile/c.AES128Encrypt.autotvout_key.dat"
#define AUTOTB_TVIN_plaintext "../tv/cdatafile/c.AES128Encrypt.autotvin_plaintext.dat"
#define AUTOTB_TVOUT_plaintext "../tv/cdatafile/c.AES128Encrypt.autotvout_plaintext.dat"
#define AUTOTB_TVIN_ciphertext "../tv/cdatafile/c.AES128Encrypt.autotvin_ciphertext.dat"
#define AUTOTB_TVOUT_ciphertext "../tv/cdatafile/c.AES128Encrypt.autotvout_ciphertext.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_data "../tv/rtldatafile/rtl.AES128Encrypt.autotvout_data.dat"
...
extern "C"
void AES128Encrypt_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_AES128Encrypt_hw(void* __xlx_apatb_param_key, void* __xlx_apatb_param_plaintext, void* __xlx_apatb_param_ciphertext)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_key;
  ...
  port0.param = &__xlx_offset_byte_param_key;
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_data),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_data),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_data),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_data),
#endif
#ifdef USE_BINARY_TV_FILE
  ...
  __xlx_offset_byte_param_key = 0*16;
  __xlx_offset_byte_param_plaintext = 1*16;
  __xlx_offset_byte_param_ciphertext = 2*16;
  port3.param = { __xlx_apatb_param_key, __xlx_apatb_param_plaintext, __xlx_apatb_param_ciphertext };
  port3.nbytes = { 16, 16, 16 };
  port3.offset = { 0, 1, 2 };
  ...
  try {
    ...
    AES128Encrypt_hw_stub_wrapper(__xlx_apatb_param_key, __xlx_apatb_param_plaintext, __xlx_apatb_param_ciphertext);
