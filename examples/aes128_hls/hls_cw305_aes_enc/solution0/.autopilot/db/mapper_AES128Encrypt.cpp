...
extern "C" void AES128Encrypt(Byte<16>*, int, int, int);
extern "C" void apatb_AES128Encrypt_hw(volatile void * __xlx_apatb_param_key, volatile void * __xlx_apatb_param_plaintext, volatile void * __xlx_apatb_param_ciphertext) {
using hls::sim::createStream;
  // Collect __xlx_key_plaintext_ciphertext__tmp_vec
std::vector<Byte<16>> __xlx_key_plaintext_ciphertext__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_key_plaintext_ciphertext__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_key)[i]);
}
  int __xlx_size_param_key = 1;
  int __xlx_offset_param_key = 0;
  int __xlx_offset_byte_param_key = 0*16;
for (size_t i = 0; i < 1; ++i){
__xlx_key_plaintext_ciphertext__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_plaintext)[i]);
}
  int __xlx_size_param_plaintext = 1;
  int __xlx_offset_param_plaintext = 1;
  int __xlx_offset_byte_param_plaintext = 1*16;
for (size_t i = 0; i < 1; ++i){
__xlx_key_plaintext_ciphertext__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_ciphertext)[i]);
}
  int __xlx_size_param_ciphertext = 1;
  int __xlx_offset_param_ciphertext = 2;
  int __xlx_offset_byte_param_ciphertext = 2*16;
  // DUT call
  AES128Encrypt(__xlx_key_plaintext_ciphertext__tmp_vec.data(), __xlx_offset_byte_param_key, __xlx_offset_byte_param_plaintext, __xlx_offset_byte_param_ciphertext);
// print __xlx_apatb_param_key
for (size_t i = 0; i < __xlx_size_param_key; ++i) {
((Byte<16>*)__xlx_apatb_param_key)[i] = __xlx_key_plaintext_ciphertext__tmp_vec[__xlx_offset_param_key+i];
}
// print __xlx_apatb_param_plaintext
for (size_t i = 0; i < __xlx_size_param_plaintext; ++i) {
((Byte<16>*)__xlx_apatb_param_plaintext)[i] = __xlx_key_plaintext_ciphertext__tmp_vec[__xlx_offset_param_plaintext+i];
}
// print __xlx_apatb_param_ciphertext
for (size_t i = 0; i < __xlx_size_param_ciphertext; ++i) {
((Byte<16>*)__xlx_apatb_param_ciphertext)[i] = __xlx_key_plaintext_ciphertext__tmp_vec[__xlx_offset_param_ciphertext+i];
}
}
