# 1 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp" 2
# 12 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp"
...
# 13 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp" 2
...
void SubBytes(unsigned char* state) {
 ...
 VITIS_LOOP_21_1: for (unsigned char i = 0; i < 16; i++) {
#pragma HLS unroll
...
void AddRoundKey(unsigned char* state, unsigned char* expanded_key) {
 ...
 VITIS_LOOP_30_1: for (unsigned char i = 0; i < 16; i++) {
#pragma HLS unroll
...
#pragma HLS array_partition variable=subbytes_key complete
 ...
 VITIS_LOOP_45_1: for (unsigned char i = 0; i < 4; i++) {
#pragma HLS unroll
 ...
 VITIS_LOOP_61_2: for (unsigned char i = 4; i < 16; i++) {
#pragma HLS unroll
 expanded_key[i] = expanded_key[i - 4] ^ key[i];
 }


 VITIS_LOOP_67_3: for (unsigned char i = 0; i < 16; i++) {
#pragma HLS unroll
...
void ShiftRows(unsigned char* state) {
 unsigned char next_state[16];
#pragma HLS array_partition variable=next_state complete
# 96 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp"
 ...
 VITIS_LOOP_116_1: for (unsigned char i = 0; i < 16; i++) {
#pragma HLS unroll
...
{
# 135 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp"
 unsigned char x_xtime[4];
 VITIS_LOOP_136_1: for (unsigned char i = 0; i < 4; i++) {
...
#pragma HLS array_partition variable=next_state complete
 ...
 VITIS_LOOP_156_1: for (unsigned char i = 0; i < 4; i++) {
#pragma HLS unroll
 MixSingleColumn(&state[i * 4], &next_state[i * 4]);
 }
 VITIS_LOOP_160_2: for (unsigned char i = 0; i < 16; i++) {
#pragma HLS unroll
 state[i] = next_state[i];
 }
}
...
__attribute__((sdx_kernel("AES128Encrypt", 0))) void AES128Encrypt(const unsigned char *key, const unsigned char *plaintext, unsigned char *ciphertext)
{
#line 77 "C:/Users/dtk/cw305-shell/examples/ip_repo/aes128_hls/create_ip.tcl"
#pragma HLSDIRECTIVE TOP name=AES128Encrypt
# 168 "../ip_repo/aes128_hls/src/AES_Encrypt.cpp"
...
#pragma HLS INTERFACE mode=m_axi port=ciphertext offset=slave bundle=data depth=16
 ...
 unsigned char scheduled_key[16];
 ap_int<8> rcon = 1;
...
#pragma HLS array_partition variable=scheduled_key complete
 ...
 LOOP_COPY_IN: for (int i = 0; i < 16; i++) {
#pragma HLS unroll
 state[i] = plaintext[i];
...
#pragma HLS PIPELINE
 ...
 LOOP_COPY_OUT: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
