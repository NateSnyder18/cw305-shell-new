...
#define CONTROL_BITS_KEY_DATA        32
#define CONTROL_ADDR_PLAINTEXT_DATA  0x18
#define CONTROL_BITS_PLAINTEXT_DATA  32
#define CONTROL_ADDR_CIPHERTEXT_DATA 0x20
#define CONTROL_BITS_CIPHERTEXT_DATA 32
